...
import com.bn1knb.newsblog.exception.NoContentException;
...
public class PostServiceImpl implements com.bn1knb.newsblog.service.post.PostService {
    ...
    public void delete(Long id, boolean hasPermission) {
        if (hasPermission) {
            ...
            throw new ArithmeticException(ACCESS_DENIED_MESSAGE);
        }
    }
    ...
    public Post save(PostDto postDto, String authorName, MultipartFile attachedFile) throws IOException {
        ...
        if (attachedFile != null) {
            newPost.setAttachedFile(attachedFile.getBytes());
        }
